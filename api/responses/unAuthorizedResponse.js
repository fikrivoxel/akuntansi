 ...
 *     // -or-
 *     return res.unAuthorizedResponse(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function unAuthorizedResponse(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.unAuthorizedResponse()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.unAuthorizedResponse()` called with an Error:', optionalData);
