 ...
 *     // -or-
 *     return res.existResponse(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function existResponse(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.existResponse()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.existResponse()` called with an Error:', optionalData);
