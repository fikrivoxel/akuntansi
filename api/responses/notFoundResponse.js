 ...
 *     // -or-
 *     return res.notFoundResponse(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function notFoundResponse(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.notFoundResponse()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.notFoundResponse()` called with an Error:', optionalData);
