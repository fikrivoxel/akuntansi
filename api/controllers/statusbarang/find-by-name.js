module.exports = {
  ...
  description: 'Find Status Barang by name',
  ...
  fn: async function (inputs, exits) {
    const total = await StatusBarang.count({
      nama_status: {
    ...
    const data = await StatusBarang.find({
      nama_status: {
        contains: inputs.nama_status
      }
    })
    ...
    return exits.notFound({
      status: 'failed',
      message: `Status Barang with name ${inputs.nama_status} not found`
    })
  }
