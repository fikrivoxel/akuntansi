module.exports = {
  friendlyName: 'Find All Harga Jual',

  description: 'Find all Harga Jual',
  ...
  fn: async function (inputs, exits) {
    const total = await HargaJual.count()
    .intercept((err) => {
    ...
    return exits.notFound({
      status: 'failed',
      message: 'No records found in Harga Jual'
    })
  }
};
